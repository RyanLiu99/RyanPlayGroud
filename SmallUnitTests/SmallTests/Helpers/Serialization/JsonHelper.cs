...
namespace SmallTests.Helpers.Serialization
{
    ...
    {
        public static JsonSerializerOptions Clone(this JsonSerializerOptions options, params Type[] converterTypesToSkip)
        {
        ...
        public static JsonSerializerOptions Clone(this JsonSerializerOptions options, params JsonConverter[] convertersToSkip)
        {
            var newOptions = new JsonSerializerOptions
            {
                IgnoreReadOnlyProperties = options.IgnoreReadOnlyProperties,
