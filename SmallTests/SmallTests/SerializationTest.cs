...
namespace SmallTests
{
    internal class SerializationTest
    {
        ...
        #region TestTuple
        [Test]
        public void TestSerializationTupleMessagepack()
        {
            TestSerializationTuple(WireUsingMessagePack);
        }

        private void TestSerializationTuple(Func<ValueDependencies, ValueDependencies> transform)
        {
