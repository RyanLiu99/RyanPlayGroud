...
namespace GcpLoggingCoreMvc
{
    ...
    public class DirectGcpLogging
    {
        public WriteLogEntriesResponse WriteLog(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            Console.WriteLine("DirectGcpLogging: Log Entries created!!");
            return response;
        }
