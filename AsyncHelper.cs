// BlockCollecton is never disposed
// SingleThreadSynchronizationContext is never disposed
// If exception happens and Complete()  is not called, it could stuck
